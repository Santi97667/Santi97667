...
<img src="img/banner.jpn">


## 💻 Quien soy?

Soy **estudiante del programa Análisis y Desarrollo de Software del Servicio Nacional de Aprendizaje (SENA)** 🧑‍💻, responsable y comprometido con el aprendizaje continuo. Con conocimientos básicos en desarrollo web usando **HTML, CSS, PYTHON y JavaScript**, experiencia en proyectos académicos, trabajo en equipo y resolución de problemas.
Me caracterizo por ser **productivo, responsable** y con disposición para asumir nuevos retos en cada **proyecto**.

🌌 **La tecnología no solo facilita el progreso, también teje redes de colaboración y creatividad.**
